...
- [исправлено] повторный клик снимает выбор файла
- [исправлено] настройка "Кнопка помощи" не работала
- [исправлено] повторная загрузка файла
...
- [исправлено] Переставлены действия в модальных окнах потверждения (кнопки "Ок" и "Отмена")
- [улучшения] Добалена микро-анимация элементов
- [улучшения] обавлено предупреждение об удалении файла при выполнении действия из тулбара
- [удалено] плагин Quantum Manager Com Media
- [новое] добавлен плагин интеграции с Yootheme Pro
- [новое] добавлена возможность загружать архивы
- [новое] добавлено отображение пустых папок. Если папка пустая, то иконка будет не закрашенной
- [новое] новая настройка: названия в unicode в именах файлов/папок при загрузке и переименовании
...
- [новое] добавлены кнопки вставки/копирования/вырезки
