1.4.1
- [исправлено] Затирание кастомныъх областей из переопредлелений в профиле
- [исправлено] Ошибка ресурсов для библиотеки (некорректно отработало, когда рабоатет imagemagick), которая обрабатывает изображения 
