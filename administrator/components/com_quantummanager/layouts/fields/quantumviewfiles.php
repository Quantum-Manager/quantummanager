...
?>
    ...
    <div class="quantummanager-module quantumviewfiles-module" data-type="Quantumviewfiles"
         data-options="<?php echo implode(';', $options) ?>">
        <div class="quantumviewfiles-module-heading  quantummanager-backgrounds-muted ">
            ...
            <div class="filter-search">
                <div class="input-wrapper">
                    ...
                    <input id="filter-search-<?php echo $id ?>" type="text" name="searchqunatumamanger"
                           placeholder="<?php echo Text::_('COM_QUANTUMMANAGER_FIELD_LABEL_FILTER_NAME'); ?>">
